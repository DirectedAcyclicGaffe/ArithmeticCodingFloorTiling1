#ifndef HALFSUCCESSHUNDRED_H
#define HALFSUCCESSHUNDRED_H
...
struct HalfSuccessHundredAttributes : public IdeaAttributes
{
    HalfSuccessHundredAttributes();
};

class HalfSuccessHundredTilerIdea : public Idea
{
    Q_OBJECT
...
public:
    explicit HalfSuccessHundredTilerIdea();
