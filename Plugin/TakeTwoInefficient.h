#ifndef TAKETWOINEFFICIENT_H
#define TAKETWOINEFFICIENT_H
...
struct TakeTwoInefficientAttributes : public IdeaAttributes
{
    TakeTwoInefficientAttributes();
};

class TakeTwoInefficientTilerIdea : public Idea
{
    Q_OBJECT
...
public:
    explicit TakeTwoInefficientTilerIdea();
