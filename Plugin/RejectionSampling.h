...
struct RejectionSampingTilerAttributes : public IdeaAttributes
{
    RejectionSampingTilerAttributes();
};

class RejectionSampingTilerIdea : public Idea
{
    Q_OBJECT
...
public:
    explicit RejectionSampingTilerIdea();
