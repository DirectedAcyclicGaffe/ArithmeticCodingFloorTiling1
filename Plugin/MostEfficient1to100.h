#ifndef MOSTEFFICIENT1TO100_H
#define MOSTEFFICIENT1TO100_H
...
struct MostEfficient1to100Attributes : public IdeaAttributes
{
    MostEfficient1to100Attributes();
};

class MostEfficient1to100TilerIdea : public Idea
{
    Q_OBJECT
...
public:
    explicit MostEfficient1to100TilerIdea();
