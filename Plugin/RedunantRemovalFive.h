#ifndef REDUNANTREMOVALFIVE_H
#define REDUNANTREMOVALFIVE_H
...
struct RedundantRemovalFiveAttributes : public IdeaAttributes
{
    RedundantRemovalFiveAttributes();
};

class RedunantRemovalFiveTilerIdea : public Idea
{
    Q_OBJECT
...
public:
    explicit RedunantRemovalFiveTilerIdea();
