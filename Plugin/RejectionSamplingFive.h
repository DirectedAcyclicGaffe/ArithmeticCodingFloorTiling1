#ifndef REJECTIONSAMPLINGFIVE_H
#define REJECTIONSAMPLINGFIVE_H
...
struct RejectionSampingFiveTilerAttributes : public IdeaAttributes
{
    RejectionSampingFiveTilerAttributes();
};

class RejectionSampingFiveTilerIdea : public Idea
{
    Q_OBJECT
...
public:
    explicit RejectionSampingFiveTilerIdea();
