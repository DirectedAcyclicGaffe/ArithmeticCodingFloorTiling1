...
Item
{
    ...
    Rectangle
    {
        ...
        Connections
        {
            ...
            function onExtendLeftSide(){root.width += 13; botStart.x += 13}
            function onExtendRightSide(){root.width += 13;}
        ...
        SequentialAnimation
        {
            ...
            PauseAnimation {duration: 6.0*idea.speed}
