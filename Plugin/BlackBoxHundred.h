#ifndef BLACKBOXHUNDRED_H
#define BLACKBOXHUNDRED_H
...
struct BlackBoxAttributes : public IdeaAttributes
{
    BlackBoxAttributes();
};

class BlackBoxHundredIdea : public Idea
{
    Q_OBJECT
