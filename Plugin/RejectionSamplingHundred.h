#ifndef REJECTIONSAMPLINGHUNDRED_H
#define REJECTIONSAMPLINGHUNDRED_H
...
struct RejectionSampingHundredTilerAttributes : public IdeaAttributes
{
    RejectionSampingHundredTilerAttributes();
};

class RejectionSampingHundredTilerIdea : public Idea
{
    Q_OBJECT
...
public:
    explicit RejectionSampingHundredTilerIdea();
...
#endif // REJECTIONSAMPLINGHUNDRED_H
