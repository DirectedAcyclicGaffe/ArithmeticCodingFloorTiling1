#ifndef MOSTEFFICIENT1TO5_H
#define MOSTEFFICIENT1TO5_H
...
struct MostEfficient1to5Attributes : public IdeaAttributes
{
    MostEfficient1to5Attributes();
};

class MostEfficient1to5TilerIdea : public Idea
{
    Q_OBJECT
...
public:
    explicit MostEfficient1to5TilerIdea();
